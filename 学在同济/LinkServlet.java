...
public class LinkServlet extends HttpServlet{
	...
	private void linkBackList(HttpServletRequest request,
		...
		try{
			...
			request.setAttribute("navCode", NavUtil.genInfoManageNavigation("友情链接管理", "友情链接维护"));
	...
	private void linkPreSave(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			if(StringUtil.isNotEmpty(linkId)){
				request.setAttribute("navCode", NavUtil.genInfoManageNavigation("友情链接管理", "友情链接修改"));
			}else{
				request.setAttribute("navCode", NavUtil.genInfoManageNavigation("友情链接管理", "友情链接添加"));
			}
