...
<body>
	...
	<div id="container">
		...
		<div class="search bar6">
			...
			<form class="form1">
				...
				<input type="text" class="input1" placeholder="请输入您要搜索的姓名" name="cname" id="key">

				<button type="button" class="button1" onclick="search()"></button>
	...
	<table id="tbl" style="margin:0 auto;"><!--使表格居中-->
